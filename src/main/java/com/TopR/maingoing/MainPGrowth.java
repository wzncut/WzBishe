...
import com.TopR.algo.AlgoAgrawalFaster94;
import com.TopR.algo.AlgoFPGrowth;
import com.TopR.algo.AssocRules;
import com.TopR.tools.Itemsets;
...
public class MainPGrowth {
	...
	public static String fileToPath(String filename) throws UnsupportedEncodingException{
		URL url = MainPGrowth.class.getResource(filename);
